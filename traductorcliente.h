...
public:
    ...
    void DeserializarInfoDeSimulacion(string json,string *obstaculos,int atributosGladiador1[10], int atributosGladiador2[10],bool *finalizacion,float *Prom1, float *Prom2, string *rutaA,string *rutaB,string *muerte1,string *muerte2);
